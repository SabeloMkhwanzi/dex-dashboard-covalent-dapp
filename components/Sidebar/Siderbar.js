  ...
  const SidebarContent = (props) => (
    ...
    >
      ...
      >
        ...
        <NavItem icon={MdGeneratingTokens}>Pools</NavItem>
        <NavItem icon={GiToken}>Tokens</NavItem>
        <NavItem icon={MdOutlineGames}>NFTs</NavItem>
        <NavItem icon={BsCurrencyExchange}>Exchanges</NavItem>
