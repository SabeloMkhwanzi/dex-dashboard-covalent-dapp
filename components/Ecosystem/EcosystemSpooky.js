     ...
     {/*Synced Block height : Section */}
        <Box>
          ...
          <Box
            ...
            as="iframe"
            height="600"
            src="https://www.tokenterminal.com/terminal/projects/spookyswap/embed/revenue" 
            ...
            as="iframe"
            height="600"
             src="https://www.tokenterminal.com/terminal/projects/spookyswap/embed/composition" 
            title="Token Terminal"
            bg={useColorModeValue("white", "gray.800")}
          />
          </SimpleGrid>
