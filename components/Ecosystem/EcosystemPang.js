    ...
    <Box
     ...
     {/*Synced Block height : Section */}
        <Box>
          ...
          <Box
            w="full" maxW="xl" mx="auto" px={2} py={2}
            paddingTop={4}
            shadow="4xl"
            rounded="md "
            borderRadius="lg"
            ...
            as="iframe"
            height="600"
            src="https://www.tokenterminal.com/terminal/projects/pangolin/embed/revenue" 
            ...
            as="iframe"
            height="600"
             src="https://www.tokenterminal.com/terminal/projects/pangolin/embed/composition" 
            title="Token Terminal"
            bg={useColorModeValue("white", "gray.800")}
          />
          </SimpleGrid>
