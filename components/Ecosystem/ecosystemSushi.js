...
import { useGetEcosystemQuery } from "../../services/ecosystemCovalentApiSushi"
     ...
     {/*Synced Block height : Section */}
        <Box>
          ...
          <Box
            ...
            as="iframe"
            height="600"
            src="https://www.tokenterminal.com/terminal/projects/sushiswap/embed/revenue" 
            title="Token Terminal"
            bg={useColorModeValue("white", "gray.800")}
            />

             <Box
            w="full" maxW="4xl" mx="auto" px={4} py={2}
            paddingTop={4}
            shadow="xl"
            rounded="md "
            borderRadius="lg"
            ...
            as="iframe"
            height="600"
             src="https://www.tokenterminal.com/terminal/projects/sushiswap/embed/composition" 
            title="Token Terminal"
            bg={useColorModeValue("white", "gray.800")}
          />
          </SimpleGrid>
